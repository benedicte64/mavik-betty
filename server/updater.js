...
function validateInstalledFiles() {
  const scripts = [
    ...
    'public/company-client.js','public/voice-access.js','public/jarvis-quote.js','public/reputation-client.js','public/command-dock.js','public/navigation-enhancer.js','public/quote-studio-client.js','public/quote-visual-preview.js','public/planning-client.js','public/workshop-client.js','public/generated/workshop/workshop-client.js','public/morale-client.js',
  ...
  const required = [
    path.join(__dirname,'public','alpha.template.html'),path.join(__dirname,'public','login.html'),path.join(__dirname,'public','profile.template.html'),path.join(__dirname,'public','jarvis.template.html'),path.join(__dirname,'public','company.html'),path.join(__dirname,'public','company.css'),path.join(__dirname,'public','company-client.js'),path.join(__dirname,'public','voice-access.js'),path.join(__dirname,'public','betty-mascot.webp'),
